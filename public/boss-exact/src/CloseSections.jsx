...
function FAQs() {
  const faqs = [
    ...
    { q: "What if I don't have time for this right now?", a: "The owners who say this are usually the ones who need it most. The diagnostic takes 3 minutes. If you're in a busy season, your coach builds the plan around your timeline — not the other way around." },
    ...
    { q: "Can I just take the diagnostic without coaching?", a: "Yes. The BOSS Diagnostic is free and takes 3 minutes. You'll see your full score across all 10 areas of your business and a calculation of the revenue gap your current score represents. You don't have to speak to a coach. But most owners do — because seeing the gap is the easy part. Closing it is what takes a coach." },
