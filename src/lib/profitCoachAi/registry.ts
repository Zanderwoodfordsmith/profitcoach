...
For the live artifact editor + copy-for-LinkedIn, point them to Get Clients → Newsletter.`,
  ...
  },
  {
    ...
    label: "Reply copilot",
    description:
      "On-demand reply drafts in Conversations. Router plus situation files. Never auto-sends.",
    placeholder: "",
    systemInstructions: `Classify the inbound against the situation map, load that play, write one sendable reply. Scorecard before calendar. One question. Never invent proof.`,
    knowledgeRefs: [
      { type: "ai-knowledge", file: "reply-copilot/ROUTER.md" },
      { type: "ai-knowledge", file: "reply-copilot/shared-rules.md" },
      { type: "ai-knowledge", file: "reply-copilot/situations/interested.md" },
      { type: "ai-knowledge", file: "reply-copilot/situations/question.md" },
      { type: "ai-knowledge", file: "reply-copilot/situations/not-yet.md" },
      { type: "ai-knowledge", file: "reply-copilot/situations/thumbs-up.md" },
      { type: "ai-knowledge", file: "reply-copilot/situations/fine-for-now.md" },
      { type: "ai-knowledge", file: "reply-copilot/situations/no-thanks.md" },
      { type: "ai-knowledge", file: "reply-copilot/situations/objection.md" },
      { type: "ai-knowledge", file: "reply-copilot/situations/quiet.md" },
      { type: "ai-knowledge", file: "reply-copilot/situations/scorecard-done.md" },
    ],
    coachPicker: false,
