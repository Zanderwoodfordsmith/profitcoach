...
import { membershipUpdatePageCopy as copy } from "@/content/membershipUpdatePageCopy";
import {
  isEmbeddedRequest,
  navigateTopWindow,
  useEmbedAutoResize,
...
const TABLE_COLS = "31% 23% 23% 23%";

const FEATURE_BLOCK_ICONS: Record<string, LucideIcon> = {
  "Brand & Marketing": Globe,
  "Directory Listing": Users,
  "OS Support Tickets": Ticket,
  "Conference Access": Presentation,
  "BOSS Score, Pro & funnels": Gauge,
  "Connect AI": Bot,
  CRM: LayoutGrid,
  "1:1 tech set‑up": Wrench,
...
const ROW_TO_FEATURE_BLOCK: Record<string, string> = {
  ...
  "OS Support Tickets": "OS Support Tickets",
  "Conference Access": "Conference Access",
  "BOSS Score, Pro & funnels": "BOSS Score, Pro & funnels",
  "Connect AI": "Connect AI",
  CRM: "CRM",
  "1:1 tech set‑up": "1:1 tech set‑up",
...
export function MembershipUpdatePageClient() {
    ...
    >
        ...
        <div className="relative z-10 mx-auto grid max-w-[1200px] items-center gap-12 px-6 pb-24 pt-10 sm:px-8 sm:pb-28 sm:pt-14 lg:grid-cols-2">
          <div>
            ...
            >
              ...
              <strong className="font-bold">{copy.hero.headlineBold}</strong>
            </h1>
            ...
            <p className="mt-6 text-sm font-medium text-white/55">
              Annual option available · Switch or cancel anytime · Stripe
            </p>
          </div>
          ...
          <div className="relative aspect-video w-full overflow-hidden rounded-2xl border border-white/15 bg-white/[0.06] shadow-2xl backdrop-blur">
            <MembershipVideoPlayer
              ...
              playLabel="Watch: how Profit Coach OS works"
      ...
      >
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4 rounded-3xl border border-slate-200 bg-white px-6 py-5 shadow-sm">
            ...
            <div className="min-w-0">
              <p className="text-[15px] font-semibold text-slate-900">
                {copy.banners.programmeActive.title}
              </p>
              <p className="text-sm text-slate-500">{copy.banners.programmeActive.body}</p>
            </div>
          </div>
        )}
        {!loading && data && isComplimentary && (
          <div className="mt-8 flex flex-wrap items-center gap-4 rounded-3xl border border-slate-200 bg-white px-6 py-5 shadow-sm">
            ...
            <p className="text-[15px] font-semibold text-slate-900">
              {copy.banners.complimentary.title}
            </p>
          </div>
        )}
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4 rounded-3xl border border-amber-200 bg-amber-50 px-6 py-5 shadow-sm">
            <div className="min-w-0">
              <p className="text-[15px] font-semibold text-amber-950">
                {copy.banners.needsChoice.title}
              </p>
              <p className="text-sm text-amber-900/80">{copy.banners.needsChoice.body}</p>
            </div>
          </div>
        )}
        ...
        >
          <div className="text-center">
            <Eyebrow>{copy.plansSection.eyebrow}</Eyebrow>
            <h2
            ...
            >
              {copy.plansSection.headlineLead}{" "}
              <strong className="font-bold">{copy.plansSection.headlineBold}</strong>
            </h2>
          </div>
      ...
      <div className="mx-auto max-w-[1200px] px-6 sm:px-8">
        ...
        <section className="pt-2 sm:pt-6">
          <div className="text-center">
            <Eyebrow>{copy.featuresSection.eyebrow}</Eyebrow>
            <h2
              className="mt-2.5 font-light text-slate-900"
              style={{ fontSize: "clamp(1.625rem, 2.6vw, 2.25rem)", letterSpacing: "-0.02em" }}
            >
              {copy.featuresSection.headlineLead}{" "}
              <strong className="font-bold">{copy.featuresSection.headlineBold}</strong>
            </h2>
          </div>
