...
export const metadata: Metadata = {
  title: "Join — Pay in full | Profit Coach",
  description: "Business Coach Academy — pay in full.",
  robots: { index: false, follow: false },
};

export default function JoinPayInFullPage() {
  return (
    <JoinCheckoutElementsPage
      offer={PROGRAMME_JOIN_OFFERS["pay-in-full"]}
